...
//!
//! Today the only decision Strata externalizes is *whose memories may a user additionally read*
//! (the cross-scope grant). [`memory_search_shared`](crate::StrataEngine::memory_search_shared)
...
//! [`StrataEngine::set_authz_backend`](crate::StrataEngine::set_authz_backend).
//!
