"""Strata vector store for LangChain."""
...
class StrataVectorStore:
    ...
    Usage::
        ...
        from langchain_strata import StrataVectorStore

        store = StrataVectorStore(url="http://localhost:8432")

        # Add texts (auto-embedded via Strata's configured provider)
    ...
    def add_texts(
        ...
        """Ingest texts as episodic events (auto-embedded by Strata pipeline)."""
        events = []
