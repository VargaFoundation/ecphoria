"""Strata retriever for LangChain — text-to-documents in one call."""

from __future__ import annotations

from typing import Any, Optional

from langchain_strata.vector_store import StrataVectorStore


class StrataRetriever:
    """LangChain-compatible retriever backed by Strata's embed-and-search.
    ...
    def __init__(
        ...
        self._store = StrataVectorStore(url=url, api_key=api_key)
        self.k = k
        self.source = source
