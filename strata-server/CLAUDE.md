...
`StrataEngine`, starts the `ClusterCoordinator` (if cluster mode enabled),
...
Minimal logic here — all business logic lives in strata-core, strata-cluster, and strata-gateway.
